      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <a href="/" className="text-white text-lg font-bold">CRM_CLIMBER</a>
          </div>
          <div className="items-center relative flex">
          <div className="flex items-center">
                <div className="flex items-center space-x-16">
                  <div className="ml-4"> {/* Добавляем отступ слева */}
            ...
            {menuOpen && (
              <div className="absolute top-full right-0 border bg-white">
                ...
                <a href="#" onClick={handleLogout} className="block px-4 py-2 flex justify-between">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
